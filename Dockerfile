...
MAINTAINER Joshua AL Rasbi
ENV PYTHONUNBUFFERED 1
ENV DJANGO_SETTINGS_MODULE=awmAssignment.settings
...
#RUN apt-get -y install build-essential python-cffi libcairo2 libpango-1.0-0 libpangocairo-1.0-0 libgdk-pixbuf2.0-0 libffi-
